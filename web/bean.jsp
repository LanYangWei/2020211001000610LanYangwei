<%@ page import="com.LanYawei.week10.StringBean" %><%--
...
<body>
    ...
    <jsp:useBean id="bean" class="com.LanYawei.week10.StringBean" />
    <jsp:setProperty name="bean" property="message" value='<%= request.getParameter("message")%>' />
    <%
//        com.LanYawei.week10.StringBean bean=new StringBean();//CHANGE with useBean -step -6
        //Step-4
